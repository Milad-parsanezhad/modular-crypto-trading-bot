...
def main() -> None:
    ...
    # v0.18 did not archive the raw frame/fingerprint. Since the public endpoint
    # is rolling, this is a refreshed reconstruction even when the same bar
    # count is requested. Do not claim a byte-identical corrected holdout.
